  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-12">
        ...
        >
          <Link href="/get-started" className="inline-flex items-center bg-[#3a7dc0] text-white px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base rounded-full hover:bg-gray-200 transition-colors">
